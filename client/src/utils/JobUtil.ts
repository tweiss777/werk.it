enum StatusColors {
  ...
  INACTIVE_BG = "#EDEBEB",
  PROCESSING_COLOR = "#E86F00",
  PROCESSING_BG = "#FFF5EB",
}
...
export function determineStatus(status: string): string[] {
  /*
...
export function determinePhase(phase: string): string[] {
  /*
        returns [bg-color, font-color]
    */
  switch (phase.toLowerCase()) {
    ...
    case "home assignment":
      return [
        PhaseColors.HOME_ASSIGNMENT_BG,
        PhaseColors.HOME_ASSIGNMENT_COLOR,
      ];
    case "got an offer!":
